...
const { calculatePipeBending } = require('./lib/calculations');
...
console.log('  Pass?', Math.abs((saddle4Result?.shrinkage || 0) - 3.75) < 0.01);
...
console.log('  Expected deduction 13" => mark at -1"?');
