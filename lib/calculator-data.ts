...
// Key is the maximum temperature for that range
export const TEMP_CORRECTION: Record<number, { f60: number; f75: number; f90: number }> = {
  25: { f60: 1.08, f75: 1.05, f90: 1.04 },
  30: { f60: 1.00, f75: 1.00, f90: 1.00 },
  35: { f60: 0.91, f75: 0.94, f90: 0.96 },
  40: { f60: 0.82, f75: 0.88, f90: 0.91 },
  45: { f60: 0.71, f75: 0.82, f90: 0.87 },
  50: { f60: 0.58, f75: 0.75, f90: 0.82 },
  55: { f60: 0.41, f75: 0.67, f90: 0.76 },
  60: { f60: 0.00, f75: 0.58, f90: 0.71 },
  70: { f60: 0.00, f75: 0.47, f90: 0.58 },
  80: { f60: 0.00, f75: 0.35, f90: 0.41 },
}
