...
import { AbsoluteFill, Sequence, Audio, staticFile, interpolate, useCurrentFrame, spring, Img } from 'remotion';
// import { loadFont } from '@remotion/fonts';
// import { Inter, JetBrains_Mono } from '@remotion/google-fonts';
